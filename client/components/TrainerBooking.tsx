...
export default function TrainerBooking() {
  ...
  const languageOptions = [
    ...
    },
    {
      ...
      name: 'Eng',
      flag: (
        <svg width="44px" height="44px" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  const [timeSlots, setTimeSlots] = useState<TimeSlot[]>([
    ...
    { id: "4", time: "10:30", available: true, selected: false },
  ...
  return (
    <div className="min-h-screen bg-background-primary">
        ...
        <>
          ...
          <div className="relative min-h-[580px] overflow-hidden">
            ...
            <img
              ...
              alt=""
              className="absolute right-0 top-2 object-contain "
            />

            <div className="wrapper min-h-[580px] relative mx-auto" style={{
              width: 'calc(100% - (2 * 120px))'
            }}>
              {/* Language selector */}
              <div className="absolute top-10 right-0 max-w-[190px] w-full">
                <div className="relative">
                  <div
                    className="flex items-center gap-2 bg-gray-100 rounded-3xl px-5 py-4 shadow-lg cursor-pointer"
                    onClick={() => setIsLanguageMenuOpen(!isLanguageMenuOpen)}
                  >
                    <div className="w-11 h-11 rounded-full overflow-hidden flex-shrink-0">
                      {languageOptions.find(lang => lang.code === selectedLanguage)?.flag}
                    </div>
                    <span className="text-content-primary text-[32px] font-medium">
                      {selectedLanguage}
                    </span>
                    <svg
                      className={`w-8 h-8 text-content-primary transition-transform ${isLanguageMenuOpen ? 'rotate-180' : ''}`}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                  ...
                  {isLanguageMenuOpen && (
                    <div className="absolute bg-gray-100 w-full rounded-b-3xl px-5 shadow-lg py-2 min-w-[120px] overflow-hidden" style={{
                      top: 'calc(100% - 20px)'
                    }}>
                      {languageOptions.filter(lang => lang.code !== selectedLanguage).map((lang) => (
                        <div
                          key={lang.code}
                          className="flex items-center gap-3  py-3 border-t-4 border-white  cursor-pointer"
                          onClick={() => {
              ...
              {/* Trainer info */}
              <div className="absolute bottom-[25px] left-0 flex items-center gap-8">
                {/* Profile picture */}
      ...
      {!showPersonalDataForm ? (
        <div className="max-w-[823px] mx-auto space-y-8 mt-8 relative z-10">
          {/* Location Section */}
          <LocationSection
            locations={locations}
        ...
        <div className="min-h-screen bg-white flex items-center justify-center p-8">
          <div className="max-w-[823px] w-full">
            ...
            <div className="text-center mb-[60px]">
              <h1 className="text-[66px] font-bold text-content-primary mb-5">
                Упс, ошибка
              </h1>
              <p className="text-[38px] text-content-secondary">
                Произошла ошибка, попробуйте записаться заново
              </p>
            </div>
            ...
            <div className="mt-12">
              <Button
                className="w-full h-[116px] text-[32px] font-semibold rounded-[40px] bg-accent-primary hover:bg-accent-secondary"
                size="lg"
                onClick={() => {
        ...
        <div className="min-h-screen bg-white flex items-center justify-center p-8">
          <div className="max-w-[823px] w-full">
            ...
            {/* Information Block */}
            <div className="mb-12">
              <h2 className="text-[56px] font-semibold text-content-primary mb-4">
                Информация
              </h2>
              <div className="">
                {/* Info Item 1 */}
                <div className="flex items-start gap-[30px] pb-8 border-b py-8 border-gray-200">
                  <div>
                  ...
                  <div>
                    <h3 className="text-[36px] mb-2 text-[#9A9B9D]">Тренер</h3>
                    <p className="text-[36px] text-[#1C1E24]">Петров Александр</p>
                  </div>
                </div>

                {/* Info Item 2 */}
                <div className="flex items-start gap-[30px] py-8 border-b border-gray-200">
                  <div>
                    <svg width="97" height="97" viewBox="0 0 97 97" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <rect x="0.600098" y="0.899902" width="96" height="96" rx="30" fill="#F6F7FA" />
                  ...
                  <div>
                    <h3 className="text-[36px] mb-2 text-[#9A9B9D]">Локация</h3>
                    <p className="text-[36px] text-[#1C1E24]">World Class </p>
                    <h4 className="text-[28px] text-[#9A9B9D]">г.Москва ул, Тверская 32</h4>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-[30px] py-8 border-b border-gray-200">
                  ...
                  <div>
                    <h3 className="text-[36px] mb-2 text-[#9A9B9D]">Услуга</h3>
                    <p className="text-[36px] text-[#1C1E24]">Инструктаж в тренажёрном зале</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-[30px] py-8 border-b border-gray-200">
                  ...
                  <div>
                    <h3 className="text-[36px] mb-2 text-[#9A9B9D]">Время</h3>
                    <p className="text-[36px] text-[#1C1E24]">10:30 - 11:00</p>
                  </div>
                </div>

                {/* Info Item 5 */}
                <div className="flex items-start gap-[30px] pt-8">
                  <div>
                    <svg width="97" height="97" viewBox="0 0 97 97" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div>
                    <h3 className="text-[36px] mb-2 text-[#9A9B9D]">Цена</h3>
                    <p className="text-[36px] text-[#1C1E24]">3 000</p>
                  </div>
                </div>
              </div>
            </div>
...
function ServicesSection({
  ...
  return (
    <Collapsible open={isOpen} onOpenChange={onToggle}>
      <Card className="px-10 py-[60px] rounded-[40px] bg-background-secondary border-0 shadow-sm">
        {/* Header */}
        <CollapsibleTrigger asChild>
          <div className="flex items-center gap-8 cursor-pointer">
            ...
            <svg
              ...
              viewBox="0 0 58 58"
              fill="none"
              className={`transform transition-transform rotate-180 ${isOpen ? 'rotate-0' : ''}`}
            >
              <path
        ...
        <CollapsibleContent>
          ...
          <div className="space-y-5 mt-10">
            {services.map((service, index) => (
              <div key={service.id}>
                {<div className="h-0.5 bg-gray-100 my-5" />}
                <ServiceItem
                  service={service}
...
function ServiceItem({
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="flex items-center gap-24 text-content-secondary">
  ...
  return (
    <Collapsible open={isOpen} onOpenChange={onToggle}>
      <Card className="px-10 py-[60px] rounded-[40px] bg-background-secondary border-0 shadow-sm">
        ...
        <CollapsibleTrigger asChild>
          <div className="flex items-center gap-8 cursor-pointer">
            ...
            <svg
              ...
              viewBox="0 0 57 56"
              fill="none"
              className={`transform transition-transform rotate-180 ${isOpen ? 'rotate-[0deg]' : ''}`}
            >
              <path
        ...
        <CollapsibleContent>
          <div className="h-0.5 bg-gray-300 mb-8 mt-8" />
            ...
            <div className="grid grid-cols-7 gap-4">
              {weekDays.map((day, index) => (
                <div key={day} className="text-center">
                  <div className="text-content-secondary text-[28px] mb-8">{day}</div>
                  <button
                    onClick={() => onSelectDate(dates[index])}
                    className={`w-20 h-20 rounded-full text-[48px] font-medium transition-colors ${selectedDate === dates[index]
          ...
          <div className="space-y-7">
            {Array.from({ length: 4 }, (_, rowIndex) => (
              <div key={rowIndex} className="grid grid-cols-2 lg:grid-cols-4 gap-8">
                {timeSlots.slice(rowIndex * 4, (rowIndex + 1) * 4).map((slot) => (
                  <button
                    key={slot.id}
                    onClick={() => onSelectTimeSlot(slot.id)}
                    disabled={!slot.available}
                    className={`px-10 py-[18px] rounded-full text-[32px] font-medium transition-colors ${slot.selected
                      ? "bg-accent-primary text-white"
                      : slot.available
