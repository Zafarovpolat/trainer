...
export default function TrainerBooking() {
  const [services, setServices] = useState<ServiceOption[]>([
    { id: '1', name: 'Инструктаж в тренажёрном зале', duration: '30 мин', price: '3 000', selected: false },
    { id: '2', name: 'Инструктаж в тренажёрном зале', duration: '30 мин', price: '3 000', selected: true },
    { id: '3', name: 'Инструктаж в тренажёрном зале', duration: '30 мин', price: '3 000', selected: false },
    { id: '4', name: 'Инструктаж в тренажёрном зале', duration: '30 мин', price: '3 000', selected: false },
  ]);
  ...
  const selectLocation = (id: string) => {
    setLocations(locations.map(location => 
      ({ ...location, selected: location.id === id })
    ));
  };

  const selectTimeSlot = (id: string) => {
    setTimeSlots(timeSlots.map(slot => 
      ({ ...slot, selected: slot.id === id && slot.available })
    ));
  };
    ...
    <div className="min-h-screen bg-background-primary">
      ...
      <div className="relative h-[580px] overflow-hidden">
        ...
        <div 
          ...
          style={{
            background: 'linear-gradient(180deg, #0047ED 36.15%, #002887 147.81%)'
          }}
        />
        ...
        <div 
          ...
          style={{
            background: 'linear-gradient(180deg, rgba(0, 0, 0, 0.00) 0%, rgba(0, 0, 0, 0.01) 12%, rgba(0, 0, 0, 0.13) 46%, rgba(0, 0, 0, 0.68) 100%)'
          }}
        />
          ...
          <div className="flex items-center gap-3 bg-gray-100 rounded-3xl px-5 py-4 shadow-lg">
            <div className="w-11 h-11 rounded-full overflow-hidden flex-shrink-0">
              <svg width="44" height="44" viewBox="0 0 44 44" fill="none">
                <path d="M21.8 40.9999C11.1961 40.9999 2.6 32.4037 2.6 21.7999C2.6 11.196 11.1961 2.59985 21.8 2.59985C32.4039 2.59985 41 11.196 41 21.7999C41 32.4037 32.4039 40.9999 21.8 40.9999Z" fill="#0052B5"/>
                <path d="M39.7908 15.0799C37.0668 7.79025 30.0393 2.59985 21.7996 2.59985C13.5599 2.59985 6.53244 7.79025 3.80847 15.0799L39.7908 15.0799Z" fill="white"/>
                <path d="M3.80957 28.5198C6.53354 35.8094 13.561 40.9998 21.8007 40.9998C30.0405 40.9998 37.0679 35.8094 39.7919 28.5198L3.80957 28.5198Z" fill="#D90026"/>
              </svg>
            </div>
            <span className="text-content-primary text-lg font-medium">Rus</span>
      ...
      <div className="max-w-4xl mx-auto px-4 lg:px-8 space-y-8 -mt-20 relative z-10">
        {/* Services Section */}
        <ServicesSection services={services} onToggleService={toggleService} />
        
        {/* Location Section */}
        <LocationSection locations={locations} onSelectLocation={selectLocation} />
  ...
  return (
    <Card className="p-15 rounded-3xl bg-background-secondary border-0 shadow-sm">
      ...
      <div className="flex items-center gap-8 mb-10">
        ...
        <svg width="58" height="58" viewBox="0 0 58 58" fill="none" className="transform rotate-90">
          <path d="M14.8001 36.2003L29.2001 21.8003L43.6001 36.2003" stroke="#8E93AD" strokeWidth="4.8" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      </div>
      ...
      <div className="space-y-5">
        {services.map((service, index) => (
          <div key={service.id}>
            ...
            <ServiceItem service={service} onToggle={() => onToggleService(service.id)} />
          </div>
        ))}
      </div>
    </Card>
...
function ServiceItem({ service, onToggle }: { 
      ...
      <div className="flex items-center justify-between text-content-secondary">
        <div className="flex items-center gap-2">
          <svg width="38" height="39" viewBox="0 0 38 39" fill="none">
            <path d="M19 35.2331C27.7445 35.2331 34.8333 28.1443 34.8333 19.3997C34.8333 10.6552 27.7445 3.56641 19 3.56641C10.2555 3.56641 3.16663 10.6552 3.16663 19.3997C3.16663 28.1443 10.2555 35.2331 19 35.2331Z" stroke="#8E93AD" strokeWidth="3.16667" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M19 9.8999V19.3999L25.3333 22.5666" stroke="#8E93AD" strokeWidth="3.16667" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
    ...
    <Card className="p-15 rounded-3xl bg-background-secondary border-0 shadow-sm">
      ...
      <div className="flex items-center gap-8 mb-10">
        <svg width="56" height="56" viewBox="0 0 56 56" fill="none">
          <path d="M28 30.3334C31.866 30.3334 35 27.1994 35 23.3334C35 19.4674 31.866 16.3334 28 16.3334C24.134 16.3334 21 19.4674 21 23.3334C21 27.1994 24.134 30.3334 28 30.3334Z" stroke="#0047ED" strokeWidth="4.66667" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M28 51.3334C37.3334 42.0001 46.6667 33.6427 46.6667 23.3334C46.6667 13.0241 38.3094 4.66675 28 4.66675C17.6907 4.66675 9.33337 13.0241 9.33337 23.3334C9.33337 33.6427 18.6667 42.0001 28 51.3334Z" stroke="#0047ED" strokeWidth="4.66667" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
        ...
        <svg width="56" height="56" viewBox="0 0 56 56" fill="none" className="transform rotate-90">
          <path d="M14 35L28 21L42 35" stroke="#8E93AD" strokeWidth="4.66667" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      </div>
      ...
      <div className="space-y-5">
        {locations.map((location, index) => (
          <div key={location.id}>
            {index > 0 && <div className="h-0.5 bg-gray-100 my-5" />}
            <LocationItem location={location} onSelect={() => onSelectLocation(location.id)} />
          </div>
        ))}
      </div>
    </Card>
...
function LocationItem({ location, onSelect }: { 
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="text-content-secondary text-2xl">
        {location.address}
      </div>
    </div>
  );
  ...
  return (
    <Card className="p-15 rounded-3xl bg-background-secondary border-0 shadow-sm">
      ...
      <div className="flex items-center gap-8 mb-8">
        <svg width="56" height="56" viewBox="0 0 56 56" fill="none">
          <path d="M28 13.9998V27.9998L37.3333 32.6665M51.3333 27.9998C51.3333 40.8865 40.8866 51.3332 28 51.3332C15.1133 51.3332 4.66663 40.8865 4.66663 27.9998C4.66663 15.1132 15.1133 4.6665 28 4.6665C40.8866 4.6665 51.3333 15.1132 51.3333 27.9998Z" stroke="#0047ED" strokeWidth="4.66667" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
        ...
        <svg width="57" height="56" viewBox="0 0 57 56" fill="none" className="transform rotate-90">
          <path d="M14.1999 35L28.2 21L42.2 35" stroke="#8E93AD" strokeWidth="4.66667" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      </div>
